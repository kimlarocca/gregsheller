...
<div class="header"> 
  ...
  <div class="headerContent">
    <h1 style="margin-bottom:40px!important"><?php echo $pageTitle; ?></h1>
...
<div class="footer">
  <div class="wf_row">
    <div class="wf_column wf_two">
      <h2><a href="index.php">Home</a> | <a href="about.php">About Me</a> | <a href="listings.php">Listings</a> | <a href="search.php">Property Search</a> | <a href="http://www.showingnew.com/gregsheller">New Home Search</a> | <a href="localInfo.php">Local Info</a> | <a href="contact.php">Contact Me</a></h2>
